...
-- 2022-11-22,GLim,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_GLim')
	 Begin 
	  Alter Database [Assignment06DB_GLim] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_GLim;
	 End
	Create Database Assignment06DB_GLim;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_GLim;
